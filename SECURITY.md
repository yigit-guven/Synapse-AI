...
Synapse AI is designed with a "Zero-Leakage" philosophy. The primary security feature of this software is that **it does not require external API calls** to third-party model providers (like OpenAI or Anthropic) for inference or embedding. All data processing happens locally on your machine or private VPS.
...
1.  **Email**: Please report sensitive bugs directly to the maintainers via email (add your email here or a dedicated security email).
